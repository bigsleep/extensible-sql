...
data SubSelect (g :: * -> *) a where
    SubSelect :: SelectQuery s g (Single a) -> SubSelect g a
    SubSelectValues :: SelectQuery s g a -> SubSelect g (ValueList a)
