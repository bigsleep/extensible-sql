...
printers :: (forall b. Maybe Relativity -> Maybe Relativity -> Expr Nodes b -> String) -> Printers Nodes a
printers p
...
pp :: Maybe Relativity -> Maybe Relativity -> Expr Nodes a -> String
pp = pretty (printers pp)

main :: IO ()
main = do
    putStrLn $ pp Nothing Nothing e1
    putStrLn "hello"
